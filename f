...
function rp(data, source) {
    if (!source) {
        ...
        var txtReplace = ['🌫_啊', '🌍_吧', '🍎_扒', '🍄_逼', '🌡_勃', '🌳_操', '🍇_插', '🌖_差', '🍐_潮', '🌹_处', '🌬_喘', '🍁_荡', '🌱_捣', '🌠_内', '🍑_顶', '🌎_恩', '🍆_干', '🌼_肛', '🌇_根', '🍊_龟', '🌦_含', '🍗_滑', '🌌_鸡', '🌯_妓', '🌮_奸', '🌶_浆', '🌛_交', '🌤_叫', '🌊_紧', '🍓_进', '🍚_茎', '🍉_精', '🌘_久', '🍂_菊', '🌟_具', '🌣_口', '🌓_裤', '🍔_浪', '🍒_力', '🌃_莉', '🍍_流', '🌙_乱', '🌀_伦', '🌂_萝', '🍃_裸', '🌩_咪', '🌲_摸', '🌭_奶', '🌠_内', '🌏_嫩', '🌪_哦', '🌅_炮', '🌈_屁', '🍙_翘', '🌝_侵', '🌜_亲', '🌒_裙', '🌑_热', '🌴_日', '🌚_乳', '🌞_入', '🌐_软', '🍕_骚', '🌾_色', '🌄_少', '🍈_射', '🍖_身', '🌨_呻', '🌸_深', '🌋_爽', '🍋_水', '🌕_丝', '🌽_舔', '🍌_腿', '🌆_臀', '🌔_脱', '🌧_吸', '🍘_下', '🍏_泄', '🌿_芯', '🌁_性', '🌉_胸', '🌻_穴', '🌗_丫', '🌺_痒', '🍅_阴', '🌥_吟', '🌷_淫', '🌢_硬', '🌰_幼', '🌵_欲'];
    }
